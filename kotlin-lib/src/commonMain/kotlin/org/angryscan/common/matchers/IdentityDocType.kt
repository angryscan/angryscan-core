...
object IdentityDocType : IHyperMatcher, IKotlinMatcher {
    ...
    override val hyperPatterns: List<String> = listOf(
        ...
        """паспорт\s+иностранного\s+гражданина""",
        """загран(?:ичный|паспорт)""",
        """(?:дипломатический|служебный)\s+паспорт""",
        """временное\s+удостоверение\s+личности""",
        """свидетельство\s+о\s+рождении""",
        """вид\s+на\s+жительство""",
        """разрешение\s+на\s+временное\s+проживание""",
        """военный\s+билет""",
        """удостоверение\s+личности\s+(?:офицера|военнослужащего|моряка)""",
        """национальный\s+паспорт"""
    )
