...
internal class PassportUSTest {
    ...
    fun testPassportUSLowerCase() {
        val text = "passport A98765432 "
        assertTrue(scanText(text, PassportUS) >= 1, "US passport with lowercase keyword should be found")
    }
    ...
    fun testPassportUSAfterAsterisk() {
        val text = "# A98765432 "
        assertTrue(scanText(text, PassportUS) >= 1, "US passport after hash with space should be found")
    }
    ...
    fun testPassportUSStartsWithZ() {
        ...
        assertEquals(0, scanText(text, PassportUS), "US passport starting with Z should not be found (only A or C allowed)")
    }
    ...
    fun testPassportUSBoundary000000000() {
        ...
        assertEquals(0, scanText(text, PassportUS), "US passport with A00000000 should not be found (excluded)")
    }

    @Test
    fun testPassportUSBoundary999999999() {
        val text = "Passport C99999999"
        assertEquals(0, scanText(text, PassportUS), "US passport with C99999999 should not be found (excluded)")
    }
    ...
    fun testPassportUSWithColonNoSpace() {
        val text = "Passport: C98765432 "
        assertTrue(scanText(text, PassportUS) >= 1, "US passport with colon and space should be found")
    }

    @Test
    fun testPassportUSExcludedA12345678() {
        val text = "Passport A12345678"
        assertEquals(0, scanText(text, PassportUS), "US passport A12345678 should not be found (excluded)")
    }

    @Test
    fun testPassportUSExcludedC12345678() {
        val text = "Passport C12345678"
        assertEquals(0, scanText(text, PassportUS), "US passport C12345678 should not be found (excluded)")
    }

    @Test
    fun testPassportUSInvalidLetterI() {
        val text = "Passport I12345678"
        assertEquals(0, scanText(text, PassportUS), "US passport with letter I should not be found")
    }

    @Test
    fun testPassportUSInvalidLetterO() {
        val text = "Passport O12345678"
        assertEquals(0, scanText(text, PassportUS), "US passport with letter O should not be found")
    }

    @Test
    fun testPassportUSAllSameCharacters() {
        val text = "Passport AAAAAAAAA"
        assertEquals(0, scanText(text, PassportUS), "US passport with all same characters should not be found")
    }
