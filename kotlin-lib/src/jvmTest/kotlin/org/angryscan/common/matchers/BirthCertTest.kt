...
/**
 * Комплексные тесты для матчера BirthCert
 */
internal class BirthCertTest : MatcherTestBase(BirthCert) {
    ...
    @Test
    fun testAtEndOfText() {
        val text = "Birth certificate: IV-АБ 123456"
    ...
    @Test
    fun testNoMatches() {
        val text = "This text has no birth certificates at all"
