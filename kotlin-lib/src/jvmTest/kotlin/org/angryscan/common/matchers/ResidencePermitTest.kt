...
internal class ResidencePermitTest : MatcherTestBase(ResidencePermit) {
    ...
    @Test
    fun testAtEndOfText() {
        val text = "Residence permit: 82 1234567"
        assertTrue(scanText(text) >= 1, "ВНЖ в конце текста должно быть найдено")
    }

    @Test
    fun testInMiddleOfText() {
        val text = "The permit 82 1234567 is valid"
    ...
    fun testInMiddleOfLine() {
        val text = "Line with 82 1234567 permit"
    ...
    fun testMultipleWithSpaces() {
        val text = "82 1234567 83 7654321"
    ...
    fun testAtTextBoundaryStart() {
        val text = "82 1234567 text"
        assertTrue(scanText(text) >= 1, "ВНЖ в начале текста должно быть найдено")
    }

    @Test
    fun testAtTextBoundaryEnd() {
        val text = "text 82 1234567"
        assertTrue(scanText(text) >= 1, "ВНЖ в конце текста должно быть найдено")
    }
    ...
    fun testWithVidNaZhitelstvoKeyword() {
        val text = "вид на жительство: 82 1234567"
        assertTrue(scanText(text) >= 1, "ВНЖ с ключевым словом должно быть найдено")
    }
